...
<head>
	...
	<!-- Le styles -->
	<link href="fontstrap/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<style type="text/css">
		body {
			padding-top: 60px;
			padding-bottom: 40px;
	...
	<link href="<?php echo $site_url; ?>/fontstrap/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
